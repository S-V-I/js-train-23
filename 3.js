...
// Клас-шаблон визначає основну логіку алгоритму, а підкласи можуть змінювати
...
class TeaMaker {
  ...
  // Робимо метод boilWater, який відповідає за кип'ятіння води та виводить
  // в консоль Кип'ятимо воду....
  ...
  // та виводить в консоль Переливаємо чай в чашку....
  // Робимо метод addCondiments, що залишається пустим
  // і може бути перевизначений у підкласах.
...
class GreenTeaMaker extends TeaMaker {
  // Робимо метод addCondiments, який виводить
  // в консоль Додаємо мед, щоб приготувати зелений чай...
...
class BlackTeaMaker extends TeaMaker {
  // Робимо метод addCondiments, який виводить
  // в консоль Додаємо мед, щоб приготувати чорний чай...
