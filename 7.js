...
// доступу до елементів колекції без розкриття його внутрішньої структури.
...
class EmployeeIterator {
  ...
  // Створимо метод #hasNext, який перевіряє, чи є в масиві працівників
  // наступний елемент для ітерації.
  ...
  // Робимо метод list, який використовується для виведення
  // імен всіх працівників в групі.
